...
public class ItemTable : TextTable<Item>
{
    ...
    public ItemTable(
		IColumnCalculator<Item> columnCalculator) : base(columnCalculator)
    {
    }
	...
	{
		AddColumn(GetColumnData(nameof(Item.Id)));
		AddColumn(GetColumnData(nameof(Item.Name)));
		AddColumn(GetColumnData(CategoryKey));
		AddColumn(GetColumnData(CategoryIdKey));
		AddColumn(GetColumnData(DetailIdKey));
		AddColumn(GetColumnData(nameof(Item.Images)));
	}

	protected override void CreateTableRow(Item e)
	{
		AddValue(GetColumnData(nameof(Item.Id)), GetId(e));
		AddValue(GetColumnData(nameof(Item.Name)), GetName(e));
		AddValue(GetColumnData(CategoryKey), GetCategory(e));
		AddValue(GetColumnData(CategoryIdKey), GetCategoryId(e));
		AddValue(GetColumnData(DetailIdKey), GetDetailId(e));
		AddValue(GetColumnData(nameof(Item.Images)), GetImages(e));
	}
