...
public class StockDetailTable : TextTable<StockDetail>
{
	...
	{
		AddColumn(GetColumnData(nameof(StockDetail.Id)));
		AddColumn(GetColumnData(nameof(StockDetail.Description)));
	}

	protected override void CreateTableRow(StockDetail e)
	{
		AddValue(GetColumnData(nameof(StockDetail.Id)), GetId(e));
		AddValue(GetColumnData(nameof(StockDetail.Description)), GetDescription(e));
	}
